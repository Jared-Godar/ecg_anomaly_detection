...
- Bump `hatchling` to 1.31.0 (uv) via Dependabot (#286).
- Bump `ipython` from 9.15.0 to 9.16.1 (uv) via Dependabot (#286).
- Bump `lightgbm` from 4.6.0 to 4.7.0 (uv) via Dependabot (#286).
- Bump `matplotlib` from 3.11.0 to 3.11.1 (uv) via Dependabot (#286).
- Bump `numpy` from 2.5.0 to 2.5.1 (uv) via Dependabot (#286).
- Bump `pre-commit` from 4.6.0 to 4.6.1 (uv) via Dependabot (#286).
