...
- Bump `https://github.com/astral-sh/ruff-pre-commit` from v0.15.22 to 0.16.0 (pre_commit) via Dependabot (#281).
- Bump `https://github.com/woodruffw/zizmor-pre-commit` from v1.27.0 to 1.28.0 (pre_commit) via Dependabot (#281).
